...
public class CTREConverter {
    /**
     * @param positionCounts Mag encoder Position Counts
     * @param gearRatio Gear Ratio between Mag encoder and Mechanism
     * @return Degrees of Rotation of Mechanism
     */
    public static double MagEncoderToDegrees(double positionCounts, double gearRatio) {
        return CANcoderToDegrees(positionCounts, gearRatio);
    }

    /**
     * @param degrees Degrees of rotation of Mechanism
     * @param gearRatio Gear Ratio between Mag encoder and Mechanism
     * @return Mag encoder Position Counts
     */
    public static double degreesToMagEncoder(double degrees, double gearRatio) {
        return degreesToCANcoder(degrees, gearRatio);
    }
